...
const app = express();
app.use(express.json()); //reads the request body and checks if there's any json object in it, then express.json() middleware takes the JSON object in the body of our request and turns it into req.body object)
